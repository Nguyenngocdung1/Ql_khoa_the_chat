 ...
 * @author NVT
 */
public class XemLichGDController {
...
//            ps.executeQuery();
    ...
    public void getLHSV(){
        Main_Model.DanhSachLH.clear();
        String sql ="Select lh.MaLop,lh.MaGv, TenLop, NgayBatDau, TietHoc, TongTiet,lh.HocPhi  from KETQUA kq, LOPHOC lh where lh.MaLop = kq.MaLop AND kq.MaSV = ?";
        try {
            PreparedStatement ps = cn.conn.prepareStatement(sql);
            ps.setString(1,Main_Model.user.getID());
//            ps.executeQuery();
